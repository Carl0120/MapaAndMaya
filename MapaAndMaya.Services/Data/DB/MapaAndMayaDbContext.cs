...
public class MapaAndMayaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //SedeCourse
        modelBuilder.Entity<SedeCourse>().HasIndex(e => new { e.CourseId, e.SedeId }).IsUnique();
        modelBuilder.Entity<SedeCourse>().HasOne(e => e.Course)
            .WithMany(e => e.SedeCourses).HasForeignKey(e => e.CourseId).IsRequired();
        modelBuilder.Entity<SedeCourse>().HasOne(e => e.Sede)
            .WithMany(e => e.SedeCourses).HasForeignKey(e => e.SedeId).IsRequired();
